...
def get_content(driver: AntiDetectDriver) -> list[str]:
    """
    Get the content of the messages in the AntiDetectDriver.

    :param driver: The AntiDetectDriver object representing the web driver.
    :return: A list of the messages in the driver.
    """
    raw_messages = extract_list(driver.get_elements_or_none_by_selector(selectors['message']))
